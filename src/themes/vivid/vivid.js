...
/**
 * vivid theme — built by `npx astryx theme build`
...
export const vividTheme = {
  ...
  tokens: {
    ...
    "--color-accent": "light-dark(oklch(0.479 0.23 264.019), oklch(0.74 0.13 264.019))",
    "--color-accent-muted": "light-dark(oklch(0.93 0.03 264.019), oklch(0.27 0.05 264.019))",
    ...
    "--color-text-accent": "light-dark(oklch(0.42 0.20 264.019), oklch(0.78 0.11 264.019))",
    ...
    "--color-icon-accent": "light-dark(oklch(0.479 0.23 264.019), oklch(0.74 0.13 264.019))",
