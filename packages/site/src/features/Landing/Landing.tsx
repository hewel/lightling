    ...
    },
    {
      ...
      content: (
        <Trans
          ...
          components={{
            'offline-translator': <Link href={'/docs/guides/OfflineTranslation'} />,
          }}
        />
      ),
    },
      ...
      content: (
        <Trans
          ...
          components={{
            ...
            ollama: <Link key="3" href="https://ollama.com/" target="_blank" />,
          }}
        />
      ),
    },
    ...
    <VStack w="100%" spacing={0}>
      <VStack w="100%" className={clsx(styles.TopScreen)}>
        <HStack
          ...
          paddingTop={'1rem'}
        >
          <Icon as={Logo} h="2rem" w="auto" boxSizing="content-box" marginRight="auto" />
        ...
        >
          ...
          >
            <VStack alignItems="start" maxWidth={'100%'}>
              <Text as="h1" fontSize={{ base: '1.8rem', md: '2.6rem' }} maxWidth={'100%'}>
                {t(['sections.hero.title'])}
              </Text>

              <Text as="div" fontSize="24px" maxW={750} whiteSpace={'pre-line'}>
                <Trans t={t} i18nKey={['sections.hero.description']}></Trans>
              </Text>

              <HStack w="100%" className={clsx(styles.ButtonsGroup)} marginTop={'2rem'}>
                <Button
                  width={{ base: '100%', sm: 'auto' }}
                  leftIcon={
                    <Image src={chromeIcon} boxSize="2em" alt="Chrome Browser logo" />
                  }
                  variant="action"
                  size="lg"
                  as="a"
                ...
                <Button
                  width={{ base: '100%', sm: 'auto' }}
                  leftIcon={
                    <Image src={firefoxIcon} boxSize="2em" alt="Firefox Browser logo" />
                  }
                  variant="action"
                  size="lg"
                  as="a"
          ...
          <VStack w="100%" alignItems="start" spacing="2rem">
            ...
            >
              ...
              <HStack alignItems="start" spacing={'3rem'} className={styles.Feature}>
                ...
                >
                  <Text as="h3" fontSize={26}>
                    {t('features.items.selectedTextTranslation.title')}
                  </Text>
                  <Text as="div" variant="description">
                    {t('features.items.selectedTextTranslation.content')}
                  </Text>
                </VStack>
              </HStack>
      ...
      >
        ...
        <Accordion defaultIndex={[0, 1]} allowMultiple fontSize={'1.2rem'} width={'100%'}>
          {faq.map((question) => (
